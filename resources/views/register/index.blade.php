                ...
                <!-- popup content for registration - start --> 
                 <div align="center" id="myModal" class="modal">
                  ...
                  @endif
                    ...
                    <form class="r-form" method="post" action="{{route('custom.register')}}" onsubmit="return validateRegForm(this)">
                      {{csrf_field()}}
                        ...
                        <p style="color:red;" id="txtHint"></p>
                         ...
                         <label>Contresena</label><br> 
                         <input type="password" id="registerpwd" name="password"  required><br>
                         <p style="color:red;" id="errorPwd"></p>
                         <label for="confirmPwd">Repetir Contresena</label><br>
                         <input type="password" name="password_confirmation" required><br> 
                            <p style="color:red;" id="err"></p>
                         <label>Direccion</label><br>
                         <textarea placeholder="" name="address" value="{{old('address')}}" required></textarea>  
                    ...
                    <div class ="logo">
                        ...
                        <nav id="homenav">
                            <ul id="respnav" class="topnav">
                                ...
                                <li><a class="active"  href="register">REGISTRO</a></li>
