        ...
        <div id="wrapper">
            ...
            <div class="hero-img">
                ...
                <div align="center" id="loginModal" class="modal ">
                    <form class="r-form login-form" method="post" action="{{route('custom.login')}}"  onsubmit="return loginValidate(this)">
                      {{csrf_field()}}
                        ...
                        <p style="color:red;" id="loginuser"></p>
                        <label>Usuario</label><br>
                         &nbsp;&nbsp;<input style=" width: 96%;" type="text" name="name"  required><br><br>
                         <p style="color:red;" id="loginpwd"></p>
                         <label>Contrasena</label><br> 
                         &nbsp;&nbsp;<input type="password" id="lgpwd" name="password"  required><br><br>
                    ...
                    <div class ="logo">
                        ...
                        <nav id="homenav">
                            <ul id="respnav" class="topnav">
                                ...
                                <li><a class="active" href="userlogin">INICIAR SESION</a></li>
                ...
                <div class="hero-text">
                  ...
                  @endif
                  @if(session('Status')== 'Authetication Failed')
